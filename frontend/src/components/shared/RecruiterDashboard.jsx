...
// // //     try {
// // //       setIsLoading(true);
// // //       // Log the headers being sent to help debug auth issues
...
// // //       } else {
// // //         console.warn("API returned failure status:", response.data.message);
// // //       }
// // //     } catch (error) {
...
// // //   const COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', '#8884d8', '#6A38C2'];
...
// // //             <h3 className="text-2xl font-bold">{dashboardData.totalJobs}</h3>
// // //           </div>
// // //         </CardContent>
// // //       </Card>
// // //       <Card>
...
// // //             <h3 className="text-2xl font-bold">{dashboardData.totalApplications}</h3>
// // //           </div>
// // //         </CardContent>
// // //       </Card>
// // //       <Card>
...
// // //               {dashboardData.jobsByStatus.find(item => item.status === "accepted")?.count || 0}
// // //             </h3>
// // //           </div>
// // //         </CardContent>
// // //       </Card>
...
// // //             <h3 className="text-2xl font-bold">
// // //               {dashboardData.jobsByStatus.find(item => item.status === "pending")?.count || 0}
// // //             </h3>
// // //           </div>
// // //         </CardContent>
// // //       </Card>
...
// // //                     <XAxis dataKey="jobTitle" angle={-45} textAnchor="end" height={70} />
// // //                     <YAxis />
// // //                     <Tooltip />
// // //                     <Legend />
// // //                     <Bar dataKey="applicationCount" fill="#6A38C2" />
// // //                   </BarChart>
// // //                 </ResponsiveContainer>
// // //               </CardContent>
// // //             </Card>
...
// // //                     <Tooltip />
// // //                     <Legend />
// // //                     <Line type="monotone" dataKey="count" stroke="#6A38C2" activeDot={{ r: 8 }} />
// // //                   </LineChart>
// // //                 </ResponsiveContainer>
// // //               </CardContent>
// // //             </Card>
...
// // //             {/* Candidates by Top Skills */}
// // //             <Card>
// // //               <CardHeader>
// // //                 <CardTitle>Candidates by Top Skills</CardTitle>
// // //               </CardHeader>
// // //               <CardContent className="h-80">
// // //                 <ResponsiveContainer width="100%" height="100%">
// // //                   <BarChart
// // //                     data={dashboardData.candidatesBySkill}
// // //                     layout="vertical"
...
// // //                           <td className="p-2">{app.candidateName}</td>
...
// // //                     <div className="text-center p-4 text-gray-500">No recent applications</div>
// // //                   )}
// // //                 </div>
// // //               </CardContent>
// // //             </Card>
