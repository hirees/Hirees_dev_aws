...
import { singleUpload, multipleUploads } from '../middleware/multer.js';
...
// Accept both profilePhoto and resume files via multipart/form-data
router.put('/update', isAuth, multipleUploads, updateProfile);
